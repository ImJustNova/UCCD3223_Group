...
public class SignUpAccActivity extends AppCompatActivity {
    ...
    private void makeTermsClickable(TextView textView) {
        ...
        // Create SpannableString from full text
        ...
        // Apply ClickableSpan to the terms text
        ...
        // Set text and make it clickable
    ...
    private void signUpUser(String name, String email, String password) {
        ...
        // For example, you can make a network request to your server here
        // to create a new user account with the provided details
    }
}
